// URL CONFIG
export const BaseApiUrl = 'http://192.168.68.107:8000/';
...
export const siteTagLine = 'Website Tag Line';
export const metaSiteTitle = siteTagLine + ' | ' + siteTitle;
export const metaDesc =
  "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled";
export const metaKeywords =
  'Lorem, Ipsum, dummy, text, typesetting, industry, standard, printer, galley, scrambled';
